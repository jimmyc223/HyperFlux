      ...
      {words.map((word, index) => {
        ...
        return (
          <span
            ...
            style={{
              color: isRevealed ? "var(--foreground)" : "#2a2a2a",
            }}
          >
        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              ...
              >
                <h2 className="max-w-3xl font-bold leading-tight tracking-widest uppercase text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Power", "Without", "Limits."].map((word, index) => {
